          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-6"><img src="assets/images/ondelete.svg" alt="" 
               style="margin-left: 22vh; height: 22px; width: 20px;"></div>
            </div>
          </div>
          <div class="row">
            <div class="col-9" style="color: white;">${authorx.content}</div>
            <div class="col-3" style="color: white;">${authorx.created_date}</div>
          </div>
          <div class="row">
            <div class="col-12">Lien de la visio :<link rel="stylesheet" href="${authorx.subject}"> ${authorx.subject} </div>
          </div>
        </div>
      </div>
</a> 
